...
function Hero() {
  return (
    <section className="relative px-4 md:px-8 lg:px-16 py-8 md:py-16 overflow-hidden h-[830px] md:h-auto md:min-h-[500px] flex flex-col">
      <img
        src={drGabrielHero}
      ...
      <div className="relative max-w-[var(--size-max-width)] mx-auto w-full flex-1 flex flex-col">
        ...
        <div className="space-y-5 max-w-2xl mt-12 md:mt-24">
