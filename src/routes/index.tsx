    ...
    <section className="px-4 md:px-8 lg:px-16 py-8 md:py-16 bg-white flex justify-center">
      <div className="max-w-[var(--size-max-width)] mx-auto text-left md:text-center space-y-4">
        ...
        <div className="mt-10 md:mt-12">
          <div className="flex flex-col lg:flex-row gap-6 lg:justify-center items-center">
            {reviews.map((r, i) => (
              <div
                key={i}
                className="premium-card p-6 md:p-8 text-left w-full max-w-2xl lg:max-w-[360px] lg:h-full space-y-4"
              >
